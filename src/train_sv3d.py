...
from src.models import SV3D, get_lr_scheduler, get_optimizer
...
def main():
    ...
    train_dataset = ConcatDataset([train_thuman_dataset, train_2k2k_dataset])
    logger.info(
    ...
    while True:
        ...
        for batch in active_train_loader:
            ...
            if accelerator.sync_gradients:
                ...
                # Save checkpoint
                if global_update_step % configs["train"]["save_freq"] == 0:
                    if accelerator.is_main_process:
