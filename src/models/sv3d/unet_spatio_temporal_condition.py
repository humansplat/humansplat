...
class MLMFModule(nn.Module):
    def __init__(self, in_channels=8):
        super(MLMFModule, self).__init__()
...
class UNetSpatioTemporalConditionModel(
    ...
    def __init__(
        ...
        self.add_angle_proj = Timesteps(
            2 * addition_time_embed_dim, True, downscale_freq_shift=0
        )
    ...
    def forward(
        ...
        added_time_ids: Union[torch.Tensor, List[torch.Tensor]] = None,
        ...
        # disable aug_embbding for image->video novel view sync.
        ...
        # 2. pre-process
        if hasattr(self, "mlmf"):
            sample = self.mlmf(sample)
