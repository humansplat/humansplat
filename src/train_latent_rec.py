...
from src.data import GObjaverseDataset, TarDataset
from src.models import LGM, get_lr_scheduler, get_optimizer
...
def main():
    ...
    parser.add_argument(
        "--wandb_token_path",
        type=str,
        default="/tmp/lgm_setup/.cache/wandb/token",
