...
cfg.device = "cuda"
cfg.device_id = "0"
cfg.pretrained_modelpath = os.path.join(cfg.pixie_dir, "extensions/pixielib/HPS/pixie_data",
                                        "pixie_model.tar")
...
# ---------------------------------------------------------------------------- #
cfg.model = CN()
cfg.model.topology_path = os.path.join(cfg.pixie_dir, "extensions/pixielib/HPS/pixie_data",
                                       "SMPL_X_template_FLAME_uv.obj")
cfg.model.topology_smplxtex_path = os.path.join(cfg.pixie_dir,
                                                "extensions/pixielib/HPS/pixie_data",
                                                "smplx_tex.obj")
cfg.model.topology_smplx_hand_path = os.path.join(cfg.pixie_dir,
                                                  "extensions/pixielib/HPS/pixie_data",
                                                  "smplx_hand.obj")
cfg.model.smplx_model_path = os.path.join(cfg.pixie_dir, "extensions/pixielib/HPS/pixie_data",
                                          "SMPLX_NEUTRAL_2020.npz")
cfg.model.face_mask_path = os.path.join(cfg.pixie_dir, "extensions/pixielib/HPS/pixie_data",
                                        "uv_face_mask.png")
cfg.model.face_eye_mask_path = os.path.join(cfg.pixie_dir, "extensions/pixielib/HPS/pixie_data",
...
cfg.model.smplx_tex_path = os.path.join(cfg.pixie_dir, "extensions/pixielib/HPS/pixie_data",
                                        "smplx_tex.png")
cfg.model.mano_ids_path = os.path.join(cfg.pixie_dir, "extensions/pixielib/HPS/pixie_data",
                                       "MANO_SMPLX_vertex_ids.pkl")
cfg.model.flame_ids_path = os.path.join(cfg.pixie_dir, "extensions/pixielib/HPS/pixie_data",
